            ...
            {step === 3 && savedTx && (
              <div className="flex flex-col items-center pt-8 text-center">
                ...
                <div className="mt-10 flex w-full max-w-xs flex-col gap-3">
                    ...
                    <a href={receiptPdfUrl(savedTx.id)} target="_blank" rel="noreferrer" className="rounded-full bg-brass px-6 py-4 text-center font-semibold text-ink-deep">Download receipt</a>
                  <button
                    type="button"
